...
import com.example.siddharth.newsreader.Comman.IS08601Parse;
import com.example.siddharth.newsreader.DetailActivity;
...
private List<Article> articleList;
    ...
    public void onBindViewHolder(ListNewsViewHolder holder, int position) {
        ...
        try
        {
            date= IS08601Parse.ISO8601DateParser.parse(articleList.get(position).getPublishedAt());
